...
console.log("\"".concat(famous_person, "\" once said, \"").concat(message, "\"")); // Interpolation Method
...
//* Answer 09:
var favNum = 59;
console.log("My favourite number is ".concat(favNum)); //Interpolation Method
...
//* Answer 11:
var names = ["Batman", "Superman", "Ironman", "Flash", "Gojo", "Geto", "Goku"];
...
//* Answer 12:
for (var i = 0; i < names.length; i++) {
    console.log("Hello my good friend ".concat(names[i], ", let's protect the city together."));
}
//? Question 13: Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”
//* Answer 13:
var transportation = ["Ferrai LaFerrai", "Bentley Continental GT", "Rolls Royce Phantom", "Lamborghini Urus", "Ducati"];
for (var i = 0; i < transportation.length; i++) {
    console.log("I would like to own a ".concat(transportation[i]));
}
//? Question 14: Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
//* Answer 14:
var guests = ["Batman", "Superman", "Ironman", "Flash", "Gojo", "Geto", "Goku"];
for (var i = 0; i < guests.length; i++) {
    console.log("I would like to invite ".concat(guests[i], " to my dinner party."));
}
